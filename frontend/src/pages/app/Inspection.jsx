...
export default function Inspection() {
  ...
  const handleRunInspection = async () => {
    ...
    try {
      ...
      let reportData = { cause_explanation: "Deviation not severe. Within nominal limits." };

      // 2. Only generate Grok defect report mapping if it fails inspection
      if (!pass) {
        reportData = await api.getReport(
          selectedProductId, 
          'Unknown Category', 
          inference.anomaly_score, 
          inference.heatmap_base64
        );
      }
      ...
      addInspection({
        ...
        likelyIssue: pass ? "No defect found." : reportData.cause_explanation,
              ...
              <div className="flex flex-col md:flex-row gap-8">
                 ...
                 <div className="w-full md:w-1/3 flex flex-col justify-center gap-4">
                    <div className="flex items-center justify-between text-sm">
                       ...
                       <span className="text-blue-600 font-medium">ResNet PaDiM</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                       <span className="text-gray-500">Generative QA</span>
                       <span className="text-orange-500 font-medium">Grok API</span>
                    </div>
                 </div>
              </div>
           </Card>
              ...
              <div className="space-y-6">
                 <div>
                    <div className="flex justify-between mb-2">
                       ...
                       <span className="text-sm text-blue-900 font-medium">Grok PaDiM Link</span>
                    </div>
